...
public interface IOpportunityService {
  ...
  /**
   * Returns the current attempt number of the exam
   *
   * @param opportunityInstance The object containing exam/opportunity metadata
   * @return The current attempt number of the exam
   */
  int getAttemptNumber(final OpportunityInstance opportunityInstance) throws ReturnStatusException;
}
